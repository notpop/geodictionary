...
const tiles = [
  ...
  { href: '/regions', label: '地域別', color: 'bg-rose-500', area: '5 / 1 / 6 / 2', textClass: 'text-[26px]' },
  { href: '/power-companies', label: '電柱', color: 'bg-amber-500', area: '5 / 2 / 6 / 3', textClass: 'text-[38px]' },
  { href: '/infrastructure', label: 'インフラ', color: 'bg-indigo-600', area: '5 / 3 / 6 / 5', textClass: 'text-[40px]' },
]

export default function Home() {
  return (
    <>
      <style>{`body{background:#0f172a!important;overflow:hidden!important}`}</style>
      <div
